...
<div class="boom_keep">
	<div class="pad20">
			...
			<div id="add_wall_form">
				...
				<div class="main_post_control">
					...
					<div class="main_post_button">
						<button onclick="postWall();" class="small_button rounded_button theme_btn"><i class="ri-send-plane-fill"></i> <?php echo $lang['post']; ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="centered_element">
			<button id="data_count" onclick="moreWall(this);" class="theme_btn small_button rounded_button load_more"  data-current="10" data-total="<?php echo $post_count; ?>"><i class="ri-add-circle-fill"></i> <?php echo $lang['load_more']; ?></button>
		</div>
		<?php } ?>
	</div>
</div>
