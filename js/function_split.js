var regSpinner = '<i class="spinner spinner1 reg_spinner"></i>';
var largeSpinner = '<div class="large_spinner"><i class="spinner spinner1  boom_spinner"></i></div>';

function fuse_loader(div, status,text) {
    if(status=="show"){
        $(div).append('<div id="loadingDiv" class="fuse_loader_content"> <div class="fuse_loader"> <span></span> <span></span> <span></span> <span></span> </div><small id="loader_text">'+text+'</small></div>');
    }else if(status=="hide"){
...
boomAddJs = function(addFile){
	$('head').append('<script  data-cfasync="false" src="'+addFile+bbfv+'"/></script>');
}
adjustSide = function(){
