	...
	<div class="docu_box">
		...
		<div class="docu_content">
			<div class="docu_description">
				...
				when a user is muted the <span class="error"><i class="ri-blur-off-fill"></i></span> icon will apear on side of his / her username in the list.
			</div>
		</div>
	</div>
	<div class="docu_box">
	...
	<div class="docu_box">
		...
		<div class="docu_content">
			<div class="docu_description">
				...
				a <span class="warn"><i class="ri-blur-off-fill"></i></span> will apear on side of his / her name in the userlist.
			</div>
		</div>
	</div>
	<div class="docu_box">
