	...
	<div class="reply_content">
		<div class="btable">
			<div class="bcell_top maxflow">
				<span class="<?php echo myColor($boom); ?> text_small username"><?php echo $boom['user_name']; ?></span> <span class="text_xsmall no_break date"><?php echo displayDate($boom['reply_date']); ?></p>
			</div>
