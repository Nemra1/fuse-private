<?php
$border = fu_borderLevel($data['user_level']);
$level_background = fu_levelColors($data['user_level']);
$user_exp = fu_levelColors($data['user_level']);
?>
<style>
	...
	<div class="store_frames box_height500">
		<div class="store_grid-container">
			<label for="frame_pack_frame_1" data-pack-name="frame_1" class="store_card" style="background-image: url(system/wallet/w3.gif);">
				<input data-ext="png" data-type="frame_tab" type="radio" data-id="frame_1" name="pack_selection" id="frame_pack_frame_1" value="371" style="display:none;" />
				<div class="store_content store_content_rank">
					<div class="store_logo">
						<img src="system/wallet/w5.jpg" alt="" class="image" />
					</div>
					<div class="store_main_text ">
						<p><i class="ri-shield-star-line"></i>Your Level</p>
					</div>
					<div class="store_price_text">
						<button class="btn <?php echo $border; ?> <?php echo $level_background; ?>">Level <?php echo $data['user_level']; ?></button>
					</div>
			...
			<label for="frame_pack_frame_2" data-pack-name="frame_2" class="store_card" style="background-image: url(system/wallet/w4.gif);">
				<input data-ext="png" data-type="frame_tab" type="radio" data-id="frame_2" name="pack_selection" id="frame_pack_frame_2" value="371" style="display:none;" />
				<div class="store_content store_content_rank">
					<div class="store_logo">
						<img src="system/wallet/w6.jpg" alt="" class="image" />
					</div>
					<div class="store_main_text">
						<p><i class="ri-shield-star-line"></i>Your EXP</p>
					</div>
					<div class="store_price_text">
						<button class="btn bgcolor24">EXP  <?php echo $data['user_exp']; ?></button>
					</div>
					<i class="ri-check-line check-icon"></i>
				</div>
			</label>
			<label for="frame_pack_frame_3" data-pack-name="frame_3" class="store_card" style="background-image: url(system/wallet/w7.gif);">
				<input data-ext="png" data-type="frame_tab" type="radio" data-id="frame_3" name="pack_selection" id="frame_pack_frame_3" value="371" style="display:none;" />
				<div class="store_content store_content_rank">
					<div class="store_logo">
						<img src="<?php echo goldIcon(); ?>" alt="" class="image" />
					</div>
					<div class="store_main_text">
						<p><i class="ri-shield-star-line"></i>Your Gold</p>
					</div>
					<div class="store_price_text">
						<button class="btn warn_btn">Gold 371</button>
					</div>
					<i class="ri-check-line check-icon"></i>
				</div>
			</label>
