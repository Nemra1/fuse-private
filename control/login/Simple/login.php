				...
				<div class="intro_social_container">
					<div class="intro_social_content">
                        ...
                        <?php if(boomSocial('google_login')){ ?>
                            <img onclick="window.location.href='<?php echo getSocialLoginCallbackUrl('google'); ?>'" 
                                 class="intro_social_btn bclick" 
                                 src="<?php echo $data['domain']; ?>/default_images/social/google.svg"/>
                        <?php } ?>
